...
class IntroductionExampleViewController : ViewController {
    @IBOutlet private var a: NSTextField!
    @IBOutlet private var b: NSTextField!
    @IBOutlet private var c: NSTextField!

    @IBOutlet private var leftTextView: NSTextView!
    @IBOutlet private var rightTextView: NSTextView!
    @IBOutlet private var speechEnabled: NSButton!
    @IBOutlet private var slider: NSSlider!
    @IBOutlet private var sliderValue: NSTextField!

    @IBOutlet private var disposeButton: NSButton!
