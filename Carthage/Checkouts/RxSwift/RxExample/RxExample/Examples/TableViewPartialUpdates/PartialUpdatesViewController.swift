...
class PartialUpdatesViewController : ViewController {
    ...
    @IBOutlet private weak var reloadTableViewOutlet: UITableView!
    @IBOutlet private weak var partialUpdatesTableViewOutlet: UITableView!
    @IBOutlet private weak var partialUpdatesCollectionViewOutlet: UICollectionView!
