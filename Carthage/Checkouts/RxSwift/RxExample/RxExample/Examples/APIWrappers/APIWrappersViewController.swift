...
class APIWrappersViewController: ViewController {
    ...
    @IBOutlet private weak var openActionSheet: UIButton!

    @IBOutlet private weak var openAlertView: UIButton!

    @IBOutlet private weak var bbitem: UIBarButtonItem!
    ...
    @IBOutlet private weak var mypan: UIPanGestureRecognizer!
