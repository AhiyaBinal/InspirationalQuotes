...
class GeolocationViewController: ViewController {
    ...
    @IBOutlet private weak private var noGeolocationView: UIView!
    @IBOutlet private weak private var button: UIButton!
    @IBOutlet private weak private var button2: UIButton!
