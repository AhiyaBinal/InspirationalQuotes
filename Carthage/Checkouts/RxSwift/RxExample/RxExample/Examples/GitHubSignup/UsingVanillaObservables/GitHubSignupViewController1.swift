...
class GitHubSignupViewController1 : ViewController {
    ...
    @IBOutlet private weak var usernameValidationOutlet: UILabel!

    @IBOutlet private weak var passwordOutlet: UITextField!
    @IBOutlet private weak var passwordValidationOutlet: UILabel!

    @IBOutlet private weak var repeatedPasswordOutlet: UITextField!
    @IBOutlet private weak var repeatedPasswordValidationOutlet: UILabel!
